...
class MediumModeController: UIViewController{
    /*var items1: [String] = []
    ...
    extension GameLevelEasy : UICollectionViewDataSource
    {
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
        {
            if collectionView == self.collectionView1
            {
                ...
                cell.teacherPhoto.image = UIImage(named: self.items1[indexPath.row])
                return cell
            }
            else
            {
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell2", for: indexPath) as! CustomCell
                cell.teacherPhoto.image = UIImage(named: self.items2[indexPath.row])
                return cell
            }
        }
    }
